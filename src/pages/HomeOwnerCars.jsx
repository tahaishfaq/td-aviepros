  ...
  const fetchCars = async () => {
    ...
    try {
      const res = await axiosInstance.get(
        `/api/method/aviepros-get-cars?homeowner_address=${user?.homeowner_address}`
      );
      console.log("Fetched cars:", res?.data?.data);
  ...
  return (
    <div className="max-w-[545px] mx-auto px-4 sm:px-0 lg:px-0 md:px-2 pt-6 pb-3 space-y-6">
      ...
      <div className="flex items-end gap-x-2.5">
        ...
        <h1 className="text-2xl font-normal">Cars</h1>
      </div>
            ...
            >
              ...
              <div className="space-y-4 px-4 pb-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-normal">{car?.owner_name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-700 font-light">
                    Model
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-normal">
                    {car?.access_tag_1 || "Not Available"}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700 font-light">
                  ...
                  <div
                    ...
                    style={{ backgroundColor: car.vehicle_color }}
                  ></div>
                </div>
              </div>
            </div>
